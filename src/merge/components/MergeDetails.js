...
import MergeDetailsBasic from "./MergeDetailsBasic";
import mergeConditionStore from "../store/MergeConditionStore";
import MergeDetailsCommit from "./MergeDetailsCommit";
import MergeDetailsFile from "./MergeDetailsFile";
...
export default inject('repositoryStore')(observer(MergeDetails))
