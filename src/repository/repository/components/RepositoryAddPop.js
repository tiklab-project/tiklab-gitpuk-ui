...
const RepositoryAddPop = props =>{
    ...
    const {repositoryStore,location,visible,setVisible} = props
    ...
    const option=[
        {label: '用户', options: [{label: getUser().name?getUser().name:getUser().phone, value: getUser().userId}]},
        {label: '仓库组', options:groupOptions},
    ]
    ...
    const newRepository = (
        ...
        >
            ...
            <div className='repository-edit-path'>
            ...
            <Form.Item name='init' label='初始化仓库'>
                <div className='repository-edit-init'>
                    <div>
                    ...
                    <div>
                        ...
                        {
                            isGitignore===1&&
                            <div className='repository-edit-git'>
                                <Select
                                    showSearch
                                ...
                                {
                                    gitignoreError&&
                                    <div className='repository-edit-init-error'>{gitignoreError}</div>
                                }
                            </div>
                        }
                    </div>
    ...
    return(
        <Modals
            ...
            title={"新建仓库"}
        >
            <div className='xcode repository-edit'>
                <div className='repository-edit-content'>
                    <div className='repository-edit-bottom'>
                        {newRepository}
                    </div>
                </div>
                {
...
export default inject('repositoryStore')(observer(RepositoryAddPop))
