...
import './repositoryBasic.scss'

const RepositoryBasic = props =>{

    const {repositoryStore} = props

    const {houseInfo,deleteCode,isLoading} = repositoryStore
...
export default inject('repositoryStore')(observer(RepositoryBasic))
